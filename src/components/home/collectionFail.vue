  ...
  export default {
    ...
    data () {
      return {
        ...
        reason: sessionStorage.getItem('codeResult') ? sessionStorage.getItem('codeResult') != 'null' ? sessionStorage.getItem('codeResult').indexOf(':') != -1 ? sessionStorage.getItem('codeResult').split(':')[1] : sessionStorage.getItem('codeResult') : '支付超时了' : '支付超时了', // 支付失败的原因
